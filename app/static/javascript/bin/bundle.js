...
var after = __webpack_require__(156);
...
var binary = __webpack_require__(149);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits__ = __webpack_require__(47);
...
var io = __webpack_require__(146)('http://' + document.domain + ':' + location.port);
...
var yeast = __webpack_require__(83);
...
var m=__webpack_require__(15),n=__webpack_require__(21),p=__webpack_require__(3),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(51),B=__webpack_require__(15),C=__webpack_require__(3),ba=__webpack_require__(52),da=__webpack_require__(53),ea=__webpack_require__(54),fa=__webpack_require__(55),ia=__webpack_require__(56),D=__webpack_require__(21);
...
var _DropFileInput = __webpack_require__(101);

var _DropFileInput2 = _interopRequireDefault(_DropFileInput);
...
var _File = __webpack_require__(102);
...
var DropFileInput = function (_Component) {
	_inherits(DropFileInput, _Component);

	function DropFileInput(props) {
		_classCallCheck(this, DropFileInput);

		var _this = _possibleConstructorReturn(this, (DropFileInput.__proto__ || Object.getPrototypeOf(DropFileInput)).call(this, props));

		_this.handlerOnDragOver = function (event) {
			event.preventDefault();
		};

		_this.handlerOnDrop = function (event) {
			/*
   ...
   */
			...
			for (var i = 0; i < event.dataTransfer.files.length; i++) {
				...
				if (!_this.state.files.map(function (n) {
					return n.name;
				}).includes(file.name)) {
			...
			_this.setState({
				files: [].concat(_toConsumableArray(_this.state.files), array_files),
				uploading: false
			});
		};

		_this.toggleUpload = function () {
			_this.setState({ uploading: !_this.state.uploading });
		};

		_this.removeFile = function (index) {
			_this.setState({
				files: _this.state.files.filter(function (_, i) {
					return i !== index;
				})
			});
		};
	...
	_createClass(DropFileInput, [{
		key: 'render',
		value: function render() {
			var _this2 = this;

			var files = this.state.files.map(function (file, index) {
				return _react2.default.createElement(_File2.default, { file: file,
					key: file.name,
					chunk_size: _this2.state.chunk_size,
					uploading: _this2.state.uploading,
					clickRemove: _this2.removeFile.bind(_this2, index)
				});
			});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'Drop-input', onDragOver: this.handlerOnDragOver, onDrop: this.handlerOnDrop },
					'Drop files here!'
				),
				_react2.default.createElement(
					'div',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ onClick: this.toggleUpload, disabled: !files.length && true },
...
var _rcProgress = __webpack_require__(103);

var _actions = __webpack_require__(145);

var _io = __webpack_require__(74);
...
var File = function (_PureComponent) {
	...
	function File(props) {
		...
		_this.uploadFile = function () {
			return (0, _actions.readFileChunk)(_this, 0, props.chunk_size);
		};
		_this.onReadError = function () {
			return (0, _actions.onReadError)(_this, 'Upload rejected by server');
		};
		return _this;
	}
	...
	_createClass(File, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			...
			if (nextProps.uploading && !this.state.done && !this.state.invalid) {
				_io2.default.emit('start-transfer', this.props.file.name, this.props.file.size, function (filename) {
					if (!filename) {
						_this2.onReadError(); // The server rejected the transfer
					} else {
						_this2.setState({ server_filename: filename }, function () {
							_this2.uploadFile();
						});
					}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				!this.state.done && _react2.default.createElement(
					'button',
					{ className: 'File-button-remove', onClick: this.props.clickRemove },
					'Remove File'
				),
				this.props.uploading && _react2.default.createElement(_rcProgress.Line, { percent: this.state.progress.percent,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Line__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__enhancer__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__types__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__enhancer__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__types__ = __webpack_require__(72);
...
function readFileChunk(ctx, offset, length) {
	...
	if (end_offset > ctx.props.file.size) end_offset = ctx.props.file.size;
...
var onReadSuccess = function onReadSuccess(ctx, offset, length, data) {
	// Read success callback
	if (ctx.state.done) return;

	_io2.default.emit('write-chunk', ctx.state.server_filename, offset, data, function (offset, ack) {
		if (!ack) {
			onReadError(ctx, 'Transfer aborted by server');
		}
	}.bind(undefined, offset));

	var end_offset = offset + length,
	    color = '#48bd9666',
	    width = end_offset / ctx.props.file.size * 100 < 100 ? end_offset / ctx.props.file.size * 100 : 100;

	ctx.setState({
		progress: _extends({}, ctx.state.progress, {
			percent: width,
			color: color
		})
	});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(158)(module), __webpack_require__(1)))
